...
describe('demonstrator content', () => {
  ...
  it('has SunGrid, Northstar, Ember Table, Haven Realty, and Meridian Legal published and the remaining demonstrators planned', () => {
    ...
    expect(DEMONSTRATORS.filter((d) => d.status === 'planned')).toHaveLength(3);
  });

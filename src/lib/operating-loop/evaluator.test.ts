...
describe('evaluateOperatingObjectives', () => {
  ...
  test('uses the scalar priority as the canonical selection key', () => {
    const urgentReply: OperatingObjectiveDraft = {
      ...
      sourceFingerprint: 'reply_to_lead:enquiry-urgent',
      status: 'active',
    ...
    const highValueRecovery: OperatingObjectiveDraft = {
      ...
      sourceFingerprint: 'recover_lead:lead-recovery',
      status: 'active',
    ...
    const candidates: OperatingObjectiveDraft[] = [
      {
        ...
        sourceFingerprint: 'reply_to_lead:enquiry-dismissed',
        status: 'dismissed',
      ...
      },
      {
        ...
        sourceFingerprint: 'confirm_booking:booking-expired',
        status: 'expired',
      ...
      },
      {
        ...
        sourceFingerprint: 'follow_up:follow-up-active',
        status: 'active',

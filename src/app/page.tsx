...
const productCards = [
  ...
  },
  {
    ...
    summary:
      "The operations layer behind every product: queues, retries, handoffs, and learning loops that keep the AI accountable.",
    href: "/dashboard/ops",
    accent: "slate",
  },
  {
    ...
    stage: "Coming next",
    summary:
      "Techclave is a product house. Booka is first. New products launch beside it, each focused on one hard workflow.",
    href: "#roadmap",
    accent: "amber",
  },
];
        ...
        <div className="relative mx-auto flex w-full max-w-7xl flex-col px-5 py-6 sm:px-6 lg:px-8">
          ...
          <section className="grid gap-12 pb-20 pt-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
            <div className="max-w-3xl">
              ...
              <h1 className="techclave-display mt-4 max-w-5xl text-5xl text-[#10211a] sm:text-6xl lg:text-7xl">
                Techclave builds AI products that help businesses reply faster,
                sell better, book more, and recover missed revenue.
              </h1>
              <p className="mt-6 max-w-2xl text-lg leading-8 text-[#4f5d59]">
                We build practical operating software for African businesses.
                Each product is focused on one hard workflow. Booka is the
                first: an AI Revenue Front Desk for service businesses that sell
                and book through WhatsApp and Instagram.
              </p>
            ...
            <div className="grid gap-4">
              <div className="rounded-[2rem] border border-[#d8d3c4] bg-[#10211a] p-6 text-[#f5f2e8] shadow-[0_22px_80px_rgba(16,23,23,0.16)]">
                ...
                <p className="mt-3 text-sm leading-7 text-[#d7ddd9]">
                  An AI Revenue Front Desk that turns active WhatsApp and
                  Instagram enquiries into booked and paying customers, then
                  carries opted-in follow-up and repeat-business conversations
                  on WhatsApp.
                </p>
                <div className="mt-6 flex items-center justify-between border-t border-white/10 pt-5">
                  <div>
                    <div className="text-[11px] uppercase tracking-[0.26em] text-emerald-300/70">
                      Best fit
                    </div>
                    <div className="mt-2 text-sm text-[#f3efe2]">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {[
                  ...
                  <div
                    key={item.label}
                    className="rounded-[1.5rem] border border-[#d8d3c4] bg-white/80 p-4 shadow-sm"
                  >
                    <div className="text-[11px] uppercase tracking-[0.24em] text-[#6c756f]">
                      {item.label}
                    </div>
                    <div className="mt-3 text-2xl font-semibold text-[#10211a]">
                      {item.value}
                    </div>
                  </div>
                ))}
          ...
          <section id="products" className="pb-20">
            <div className="flex items-end justify-between gap-4">
              <div>
                <p className="text-xs uppercase tracking-[0.32em] text-[#6c756f]">
                  Products
                </p>
            ...
            <div className="mt-6 grid gap-4 lg:grid-cols-3">
              {productCards.map((card) => (
                <article
                  key={card.name}
                  className="rounded-[1.9rem] border border-[#d8d3c4] bg-white/85 p-6 shadow-sm"
                >
                  <div className="flex items-center justify-between gap-3">
                    <p className="text-xs uppercase tracking-[0.28em] text-[#6c756f]">
                      {card.stage}
                    </p>
                    <span
                  ...
                  <h3 className="mt-5 text-2xl font-semibold tracking-tight text-[#10211a]">
                    {card.name}
                  </h3>
                  <p className="mt-3 text-sm leading-7 text-[#53605c]">
                    {card.summary}
                  </p>
                  <Link
                    href={card.href}
            ...
            <div className="grid gap-6 lg:grid-cols-[0.92fr_1.08fr]">
              <div className="rounded-[2rem] border border-[#d8d3c4] bg-white/85 p-6 shadow-sm">
                ...
                <p className="mt-4 text-sm leading-7 text-[#53605c]">
                  Techclave builds and operates the products. Booka is the one
                  to start with today—an AI Revenue Front Desk you can pilot
                  against real enquiries. As we ship more, each product stays
                  just as specific.
                </p>
              </div>
              <div className="grid gap-4">
                {principles.map((item, index) => (
                  <article
                    key={item}
                    className="rounded-[1.5rem] border border-[#d8d3c4] bg-[#fdfcf8] p-5 shadow-sm"
                  >
                    <p className="text-xs uppercase tracking-[0.28em] text-[#6c756f]">
                      0{index + 1}
                    </p>
                    <p className="mt-3 text-lg leading-8 text-[#10211a]">
                      {item}
                    </p>
                  </article>
                ))}
              ...
              <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
                <div>
                  ...
                  <p className="mt-4 max-w-2xl text-sm leading-7 text-[#d7ddd9]">
                    Booka is live now and ready for your front desk. As
                    Techclave ships new products, they plug into the same
                    operating layer — so adding capability never means starting
                    over.
                  </p>
                </div>
                <div className="flex flex-wrap gap-3 lg:justify-end">
                  ...
                  <Link
                    href="/contact"
                    className="rounded-full border border-white/20 px-6 py-3 text-sm font-medium text-white transition hover:-translate-y-0.5 hover:bg-[#274235]"
                  >
                    Talk to us
                  </Link>
                </div>
          ...
          <footer className="flex flex-col gap-6 border-t border-[#d8d3c4] pt-8 text-sm text-[#5a625f]">

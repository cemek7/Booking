...
const VerticalModulesDashboard: React.FC<VerticalModulesDashboardProps> = ({ tenantId, userRole = 'admin' }) => {
  ...
  const loadDashboardData = useCallback(async () => {
    ...
    try {
      ...
      const [schedulingData, anomaliesData, pricingData] = [
        schedulingRes.data as MLPrediction,
        anomaliesRes.data as MLPrediction,
        pricingRes.data as MLPrediction,
      ];
                    ...
                    <div key={module.id} className="border rounded-lg p-4">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                        {(module.features && module.features.length > 0)
                          ...
                          : <span className="text-sm text-muted-foreground col-span-3">No features listed</span>
                        }
                      </div>
                    </div>
                  ))}
...
export default VerticalModulesDashboard;